...
<div class="container my-md-4 py-3">
    <section id="animal_intro">
        ...
        <div class="row text-center pt-md-3 bg-arc-dark text-light">
            <div class="col-md-8">
                <h1 class="text-light text-center pb-2">Héron</h1>
                <p class="py-2">Arcadia recense actuellement 2 espèces de "Héron".
                <p class="py-2">L'animal se trouve dans l'habitat : Les Marais de la Légende</p>

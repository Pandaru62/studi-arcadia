                    ...
                    <div class="card-body bg-light d-flex flex-column">
                        <?php if(isset($_SESSION['userEmail']) && $_SESSION['userRole'] == 'admin') {?>
                            <div class="d-flex justify-content-around mb-2">
                                <a class="btn btn-warning z-2" href="<?=BASE_URL?>/edithabitat?id=<?=$menuHabitat['id'];?>"><i class="bi bi-pencil"></i> Editer l'habitat</a>                            
                                    <button type="button" class="btn btn-danger z-2" data-bs-toggle="modal" data-bs-target="#deleteHabitat<?=$menuHabitat['id'];?>">
                                    <i class="bi bi-trash-fill"></i> Supprimer l'habitat
                                    </button>
